...
#' fitting, peak-table construction, data-visualization, etc.
...
#' \doi{10.1016/S0021-9673(01)00594-5}).More details on package usage and a 
#' suggested workflow can be found in the vignette.
#' 
