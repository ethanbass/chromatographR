...
plot_all_spectra <- function(peak=i, peak_table, chrom_list, plot_spectrum = T, plot_chrom = F,
  ...
  sp <- sapply(1:length(chrom_list), function(chr){
    plot_spectrum(peak=peak, peak_table=peak_table, chrom_list=dat.pr, chr=chr,
