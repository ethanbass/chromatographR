...
- outlier_cutoff:
  ...
  Threshold for excluding chromatograms that end prematurely.
  Chromatograms ending more than this value (in seconds) before the
  median end time are excluded. Default is 5 seconds. Only applies when
