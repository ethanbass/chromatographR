...
- weight:
  ...
  Weight provided to
  [`get_agilent_threshold`](https://ethanbass.github.io/chromatographR/dev/reference/get_agilent_threshold.md).

- cutoff:

  Proportion of maximum absorbance to use as cutoff. Argument to
  [`trim_peak`](https://ethanbass.github.io/chromatographR/dev/reference/trim_peak.md).
  Defaults to `.05`.
