...
As one might expect, the permanova results shows that species is the largest contributor to the variance in CHC profiles (R^2^<sub>marginal</sub> = `r round(m$R2[1], digits = 2)`), followed by state of origin (R^2^<sub>marginal</sub> = `r round(m$R2[2], digits = 2)`) and sex (R^2^<sub>marginal</sub> = `r round(m$R2[3], digits = 2)`).
