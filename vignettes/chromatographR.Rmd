...
```
The plot `peak_table` function provides an easy interface to various options for plotting peaks. Plot spectra or make a quick boxplot comparing an arbitrary number of treatments.
...
par(mfrow=c(2,1))
peak="X7"
plot_spectrum(peak, peak_table = pk_tab)
```
