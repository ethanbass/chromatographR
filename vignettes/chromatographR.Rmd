...
First you will usually want to attach sample meta-data to the `peak_table` object. This can be easily accomplished using the `attach_metadata` function. 
...
```{r,eval=T}
plot(pk_tab, loc = "X9", box_plot = TRUE, vars = "trt")
plot(pk_tab, loc = "X13", box_plot = TRUE, vars = "trt")
```
