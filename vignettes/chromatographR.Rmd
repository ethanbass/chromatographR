...
par(mfrow=c(2,1))
plot_peaks(chrom_list = warp, peak_list = pks_gauss, index=4, lambda='210')
plot_peaks(chrom_list = warp, peak_list = pks_egh, index=4, lambda='210')

plot_peaks(chrom_list = warp, peak_list = pks_gauss, index=4, lambda='260')
plot_peaks(chrom_list = warp, peak_list = pks_egh, index=4, lambda='260')
```
