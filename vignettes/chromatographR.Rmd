...
The plot `peak_table` function provides an easy interface to various options for plotting peaks. For example, this function can be used to plot spectra or make a quick boxplot to compare treatments in sample metadata.
