...
```{r Choose parameters for fitting baseline}
...
plot_chroms(warp, lambdas = c("210","260"), show_legend = TRUE)
...
```{r, plot_all}
peak = "V13"
plot_all_spectra(peak, peak_table = pk_tab, export = F, overlapping = TRUE)
```
