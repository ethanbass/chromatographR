...
par(mfrow=c(2,1))
plot(peak_list = pks_gauss, index=1, lambda='210')
plot(peak_list = pks_egh, index=1, lambda='210')
```
...
```{r, cluster, fig.show="hold", out.width="20%"}
cl1 <- cluster_spectra(pk_tab, warp, nboot=100, max.only = T, save = F)
```
