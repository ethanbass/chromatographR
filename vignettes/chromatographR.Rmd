...
After selecting parameters for baseline correction, you can proceed with the pre-processing step as shown below. For 2D data with just one column, the `dim2` argument should be left blank.
