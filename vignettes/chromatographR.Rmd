...
```{r choose_parameters_for_fitting_baseline}
...
In this case the alignments produced by the two algorithms are very similar, but in many cases one algorithm may dramatically outperform the other.
