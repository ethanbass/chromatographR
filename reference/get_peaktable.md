...
The function returns an S3 `peak_table` object, containing the following
elements:

- `tab`: the peak table itself – a data-frame of intensities in a sample
  x peak configuration.
